...
import com.daniilSergachev.CloudFileStorage.repositories.minio.MinioRepository;
import com.daniilSergachev.CloudFileStorage.dto.FileFolderDTO;
...
public class MinioService {
    ...
    public void delete(String nameFile, String pathToFile, Long userId, Boolean isFolder) {
        if (!isFolder) {
            ...
            List<String> listFolder = minioRepository.doSearch(getUserBucket(userId, pathToFile) + nameFile + "/");
            listFolder.forEach(minioRepository::removeFolder);
        }
    }
